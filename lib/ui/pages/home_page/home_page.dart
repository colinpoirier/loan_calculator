...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation.monthAnimationController = AnimationController(
        vsync: this, duration: AnimationProvider.expandedDuration);
    ...
    return GestureDetector(
      ...
      child: Scaffold(
            ...
            Center(
              child: Scroller.column(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    onPressed: () {
                      // textController.amount.text = _amount.toString();
                      // textController.percent.text = (_percent * 1200).toString();
                      // textController.month.text = _months.toString();
        ...
        drawer: HistoryDrawer(
            ...
            // changeTime: _changeTime,
            // iptList: iptList,
            // amountController: textController.amount,
            // percentController: textController.percent,
            // monthController: textController.month,
            ),
      ),
    );
  }
