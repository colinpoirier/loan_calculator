...
class AmountState extends SubState {
  ...
  static const _maxAmount = 100000000.0; 
  ...
  factory AmountState({required String input, required int precision}){
    ...
    return AmountState._(value: parsed, amountString: input, precision: precision);
  }

  AmountState._({this.value, String? amountString, String? error, required this.precision}): super(value: value, stringValue: amountString, error: error);
